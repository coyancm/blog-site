...
<br>
<br>
<img src="/uploads/blog/buildings.png" alt="Several buildings made for the game City Planner." style="display: block;margin-left: auto;margin-right: auto;width: 70%;border-radius: 8px;">
